...
function setupAutoUpdater() {
    ...
    electron_updater_1.autoUpdater.autoDownload = false; // user must confirm download
    electron_updater_1.autoUpdater.autoInstallOnAppQuit = true; // install silently on next quit
